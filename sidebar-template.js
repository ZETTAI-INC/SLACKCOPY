...
function getChannelSidebar(activeChannel) {
  ...
  +'<button class="sidebar-item channel-item" onclick="location.href=\'index.html\'"><span class="channel-hash">#</span><span>all-kotaro</span></button>'
  ...
  +'<div class="sidebar-section"><div class="sidebar-section-header"><span class="sidebar-section-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3"><path d="M3 3h10a1 1 0 011 1v6a1 1 0 01-1 1H6l-3 3V4a1 1 0 011-1z"/></svg></span><span>ダイレクトメッセージ</span></div><button class="sidebar-item dm-item" onclick="location.href=\'dm.html\'"><span class="dm-avatar-small"><span class="dm-avatar-img">&#128036;</span><span class="dm-status-dot online"></span></span><span>ta ko</span><span class="dm-self-label">(自分)</span></button></div>'
